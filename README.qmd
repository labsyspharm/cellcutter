...
res = subprocess.run([shutil.which("cut_cells"), "-h"], capture_output=True, check=True, text=True)
print(res.stdout)
```
...
import subprocess
res = subprocess.run([shutil.which("cut_tiles"), "-h"], capture_output=True, check=True, text=True)
print(res.stdout)
```
